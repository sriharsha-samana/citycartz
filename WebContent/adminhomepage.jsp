	...
	<script type="text/javascript">
		function initialize() {
			...
			function createDatabase(path)
				{
					window.open("AdminCreateDatabase?path="+path,"_self");
				}
...
<%
		...
		boolean connected = dbConnect.checkConnection();
		if(!connected)
		{
%>
			<li><a style="cursor:pointer;color:red" onclick="createDatabase('<%=strApplicationPath%>');">CREATE DATABASE</a></li>
<%
		}
%>
...
<div class="container">
	<br>
  	 <div class="booking-info">
			<b><span style="color:black">BOOK </span>ORDER</b>
		</div>
		<br>
		<br>
<div class="book-now-details">
<form name= "booking" id ="booking" method="post" action="AdminPreConfirm">
...
%>
					...
					<div class="booking-form-submit">
						<br><input type="submit" value="BOOK"/><br>
					</div>
				</form>
</div>
</div>
