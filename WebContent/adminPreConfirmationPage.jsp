...
<div class="container">
		...
		<br>
		<br>
		<form name="preconfirmationpage" method="post" action="AdminConfirm" onsubmit="return confirmation();">
    ...
    <div class="booking-confirm-button"><input type="submit" value="CONFIRM"></input> 
    <input type="button" value="CANCEL" onclick="cancel();"></input> </div>
    </div>
    </form>
   <script type="text/javascript">
...
<!-- //smooth scrolling -->
  <body onload="calculateDistances(); calcRoute();" onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
