...
<div class="track-order-index">
	...
	<div class="log-file-details">
			<div class="log-file-details-header">LOG FILE DETAILS</div>
<%
String value=request.getParameter("value");
String appFolder =  getServletContext().getRealPath("/");
appFolder+="/LogFiles/"+value;
LineNumberReader  lnr = new LineNumberReader(new FileReader(new File(appFolder)));
...
%>
	...
	window.open("AdminLogFileList","_self");
	</script>
<%	
}
else
{
String returnString[] = new String[linecount];
ReadFromLogFile rflf= new ReadFromLogFile();
returnString=rflf.readfromlogfile(appFolder,linecount);
%>
<table border=1>
<%
